...
|---|---|
| <img src="https://raw.githubusercontent.com/Luxfi/electron-desktop-shell/master/packages/electron-chrome-extensions/screenshot-ublock-origin.png" width="405"> | <img src="https://raw.githubusercontent.com/Luxfi/electron-desktop-shell/master/packages/electron-chrome-extensions/screenshot-dark-reader.png" width="391"> |
...
> For a complete example, see the [`electron-desktop-shell`](https://github.com/luxfi/electron-desktop-shell) project.
...
* `options` Object (optional)
  ...
  * `preloadPath` String (optional) - Path to [`preload.js`] compiled from (./src/preload.ts), which just inject extensions APIs for `chrome-extension://`. We might want to customize path to our customized `preload.js` which includes `import '@lux-wallet/electron-chrome-extensions/dist/preload'`. If not provided, default to `<modulePath>/dist/preload.js`
...
[`electron-desktop-shell`](https://github.com/luxfi/electron-desktop-shell/blob/master/packages/shell/browser/main.js)
project.
...
<img src="https://raw.githubusercontent.com/Luxfi/electron-desktop-shell/master/packages/electron-chrome-extensions/screenshot-browser-action.png" width="438">
