...
/* harmony import */ var _isomorphic_ipc__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../isomorphic/ipc */ "./src/isomorphic/ipc.ts");
...
const addExtensionListener = (extensionId, name, callback) => {
  ...
  electron__WEBPACK_IMPORTED_MODULE_0__.ipcRenderer.addListener((0,_isomorphic_ipc__WEBPACK_IMPORTED_MODULE_1__.formatIpcName)(name), function (event, ...args) {
    if (true) {
...
const removeExtensionListener = (extensionId, name, callback) => {
  ...
  electron__WEBPACK_IMPORTED_MODULE_0__.ipcRenderer.removeListener((0,_isomorphic_ipc__WEBPACK_IMPORTED_MODULE_1__.formatIpcName)(name), callback);
};
